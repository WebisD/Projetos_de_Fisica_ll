...
def nFinal(comp, unidade):
    ...
    if energiaFoton > 10.2:
        ...
        if analiseNivel.tryInt(round(nivel), nivel):
            ...
            return "Erro", "O átomo de hidrogênio não absorve um \nfóton com esse comprimento de onda."
    else:
        if energiaFoton < 10.2:
            return "Erro", "    Digite um comprimento de onda maior,\nesse fóton irá ionizar o átomo de hidrogênio."
